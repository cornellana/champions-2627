...
STRINGS: dict[str, tuple[str, str, str]] = {
    ...
    # -- Ficha del jugador -------------------------------------------------
    # Viene de la app de La Liga, que tenía estos textos escritos en el
    # código. Aquí pasan por el catálogo y `Text` los resuelve con el locale
    # del entorno, así que cambian de idioma al instante como el resto.
    # Las claves con %lld son las que genera SwiftUI para `Text("… \(n)")`.
    "player.title":           ("Statistics", "Estadísticas", "Estadístiques"),
    "player.value":           ("Value", "Valor", "Valor"),
    "player.age %lld":        ("%lld years old", "%lld años", "%lld anys"),
    "player.matchday %lld":   ("Matchday %lld", "Jornada %lld", "Jornada %lld"),
    "player.position.goalkeeper": ("Goalkeeper", "Portero", "Porter"),
    "player.position.defender":   ("Defender", "Defensa", "Defensa"),
    "player.position.midfielder": ("Midfielder", "Centrocampista", "Migcampista"),
    "player.position.forward":    ("Forward", "Delantero", "Davanter"),
    "player.column.match":    ("Match", "Partido", "Partit"),
    "player.column.average":  ("Avg", "Media", "Mitjana"),
    "player.column.total":    ("Total", "Total", "Total"),
    "player.loading":         ("Loading statistics…", "Cargando estadísticas…", "Carregant estadístiques…"),
    "player.noData":          ("Statistics not available", "Estadísticas no disponibles", "Estadístiques no disponibles"),
    "player.noData.detail":   ("No data for this player in this season's Champions League.",
                               "No hay datos de este jugador en la Champions de esta temporada.",
                               "No hi ha dades d'aquest jugador a la Champions d'aquesta temporada."),

    "player.group.general":     ("General", "General", "General"),
    "player.group.attack":      ("Attack", "Ataque", "Atac"),
    "player.group.passing":     ("Passing", "Pases", "Passades"),
    "player.group.defence":     ("Defence", "Defensa", "Defensa"),
    "player.group.discipline":  ("Discipline", "Disciplina", "Disciplina"),
    "player.group.physical":    ("Physical", "Físico", "Físic"),
    "player.group.goalkeeping": ("Goalkeeping", "Portero", "Porter"),

    "player.stat.minutes":        ("Minutes", "Minutos", "Minuts"),
    "player.stat.rating":         ("Rating", "Valoración", "Valoració"),
    "player.stat.appearances":    ("Matches", "Partidos", "Partits"),
    "player.stat.starts":         ("Starts", "Titular", "Titular"),
    "player.stat.goals":          ("Goals", "Goles", "Gols"),
    "player.stat.assists":        ("Assists", "Asistencias", "Assistències"),
    "player.stat.shots":          ("Shots", "Disparos", "Xuts"),
    "player.stat.onTarget":       ("On target", "A puerta", "A porta"),
    "player.stat.keyPasses":      ("Key passes", "Pases clave", "Passades clau"),
    "player.stat.bigChances":     ("Big chances", "Ocas. claras", "Ocas. clares"),
    "player.stat.passes":         ("Passes", "Pases", "Passades"),
    "player.stat.accuratePasses": ("Accurate passes", "Pases exactos", "Passades bones"),
    "player.stat.passPct":        ("Pass accuracy", "% Pases", "% Passades"),
    "player.stat.tackles":        ("Tackles", "Entradas", "Entrades"),
    "player.stat.tacklesWon":     ("Tackles won", "Entradas ef.", "Entrades guanyades"),
    "player.stat.interceptions":  ("Interceptions", "Intercepciones", "Intercepcions"),
    "player.stat.clearances":     ("Clearances", "Despejes", "Refusades"),
    "player.stat.recoveries":     ("Recoveries", "Recuperaciones", "Recuperacions"),
    "player.stat.aerialsWon":     ("Aerials won", "Aéreos ganados", "Duels aeris guanyats"),
    "player.stat.fouls":          ("Fouls", "Faltas", "Faltes"),
    "player.stat.possessionLost": ("Possession lost", "Pérdidas", "Pèrdues"),
    "player.stat.yellowCards":    ("Yellow cards", "Amarillas", "Grogues"),
    "player.stat.redCards":       ("Red cards", "Rojas", "Vermelles"),
    "player.stat.distance":       ("Distance (km)", "Km recorridos", "Km recorreguts"),
    "player.stat.touches":        ("Touches", "Toques", "Tocs"),
    "player.stat.saves":          ("Saves", "Paradas", "Aturades"),
    "player.stat.savesInBox":     ("Saves in the box", "Paradas (área)", "Aturades (àrea)"),
    "player.stat.goalsPrevented": ("Goals prevented", "G. evitados", "Gols evitats"),
    "player.stat.cleanSheets":    ("Clean sheets", "P. imbatida", "P. imbatuda"),
